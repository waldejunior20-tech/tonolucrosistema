...
export default defineConfig(({ mode }) => ({
  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: "TôNoLucro — Gestão de Pizzaria",
        short_name: "TôNoLucro",
        description:
          "Sistema de gestão, fichas técnicas e precificação inteligente para pizzarias e food service.",
        start_url: "/",
        scope: "/",
        display: "standalone",
        ...
        theme_color: "#2563EB",
        lang: "pt-BR",
        categories: ["business", "food", "productivity", "finance"],
        icons: [
